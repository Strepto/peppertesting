...
class SopraSteriaGreeter(object):
    ...
    def recognizePerson(self):
        ...
        if len(candidates) > 0:
            ...
            # self.textToSpeech.say('Hi, memory fault if this ends here.')
            
            self.memory.insertData('sopraSteriaGreeter/bestCandidateName', bestCandidateName)
